...
Page({
    ...
    addWeiXinUserInfo: function() {
        ...
        wx.request({
            url: //"http://192.168.100.164:8080/index/user/addUserInfo",
            app.globalData.urlRootPath + 'index/user/addUserInfo',
            data: {
            ...
            success: function (res) {
                switch (res.statusCode) {
                    case 200:
                        ...
                        //app.globalData.userInfo.nick_name = res.data.nickName;
                        //app.globalData.userInfo.avatar_url=res.data.avatarUrl;
    ...
    previewDiaryImage: function(e){
        ...
        for (let i = 0; i < length; i++)
        {
            ...
            // 加上图片访问的baseUrl  注意一定要改为http 不然预览网络图片一直黑屏
                ImgResourceList[index++] =
                    "https://armin-xu.cn/SmallPunchMiniProgramAfterEnd/"
        ...
        wx.previewImage({
            // 当前显示图片的http链接
            current: "https://armin-xu.cn/SmallPunchMiniProgramAfterEnd/"
